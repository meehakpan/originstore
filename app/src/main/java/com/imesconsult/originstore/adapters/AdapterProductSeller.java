...
import com.imesconsult.originstore.FilterProduct;
import com.imesconsult.originstore.R;
import com.imesconsult.originstore.models.ModelProduct;
import com.imesconsult.originstore.sellers.EditProductActivity;
...
public class AdapterProductSeller extends RecyclerView.Adapter<AdapterProductSeller.HolderProductSeller> implements Filterable {
    ...
    public void onBindViewHolder(@NonNull HolderProductSeller holder, int position) {
        ...
        if(discountAvailable.equals("true")){
            ...
            Picasso.get().load(icon).placeholder(R.drawable.cart_grey).into(holder.productIconIv);
    ...
    private void detailsBottomSheet(ModelProduct modelProduct) {
        ...
        if(discountAvailable.equals("true")){
            ...
            Picasso.get().load(icon).placeholder(R.drawable.cart_grey).into(productIconTv);

        }catch(Exception e){
            productIconTv.setImageResource(R.drawable.cart_grey);
        }
        ...
        editBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //open edit product activity, pass id of product to edit activity
        ...
        deleteBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                builder.setTitle("Delete")
                        .setMessage("Are you sue you want to delete product"+title+" ?")
                        .setPositiveButton("DELETE", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                //delete
                                deleteProduct(id); //id : product id
                                bottomSheetDialog.dismiss();
                            }
                        })
