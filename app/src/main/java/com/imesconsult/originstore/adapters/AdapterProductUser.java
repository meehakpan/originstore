...
import com.imesconsult.originstore.FilterProductUser;
...
public class AdapterProductUser extends RecyclerView.Adapter<AdapterProductUser.HolderProductUser> implements Filterable {
    ...
    public void onBindViewHolder(@NonNull HolderProductUser holder, int position) {
        ...
        String unitTv = modelProduct.getProductQuantity();
        ...
        holder.unitTv.setText(productQuantity);
        ...
        if (discountAvailable.equals("true")) {
            ...
            holder.discountedPriceTv.setTextColor(ContextCompat.getColor(context,R.color.colorBlack));
            ...
            holder.originalPriceTv.setTextColor(ContextCompat.getColor(context,R.color.colorBlack));
        }
        try {
            Picasso.get().load(productIcon).placeholder(R.drawable.cart_grey).into(holder.productIconIv);

        } catch (Exception e) {
            holder.productIconIv.setImageResource(R.drawable.cart_grey);
        }
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                showDialogPic(modelProduct); // todo:to be created separate activity
    ...
    private void showQuantityDialog(final ModelProduct modelProduct) {
        ...
        if (modelProduct.getDiscountAvailable().equals("true")) {
            ...
            originalPriceTv.setTextColor(ContextCompat.getColor(context,R.color.colorGrey04));
        ...
        //set data
        try{
            Picasso.get().load(image).placeholder(R.drawable.cart_grey).into(productIv);

        }catch (Exception e){
            productIv.setImageResource(R.drawable.cart_grey);
        }
        ...
        //to show the product picture only
        productIv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                showDialogPic(modelProduct);
            }
        });
    ...
    private void showDialogPic(ModelProduct modelProduct) {

        View view = LayoutInflater.from(context).inflate(R.layout.dialog_pic, null);
        ImageView productPicIv = view.findViewById(R.id.productPicIv);
        ImageButton closeBtn=view.findViewById(R.id.closeBtn);
        String image = modelProduct.getProductIcon();
        AlertDialog.Builder builder=new AlertDialog.Builder(context);
        builder.setView(view);
        try{
            Picasso.get().load(image).placeholder(R.drawable.cart_grey).into(productPicIv);

        }catch (Exception e){
            productPicIv.setImageResource(R.drawable.cart_grey);
        }
        final AlertDialog dialogPic = builder.create();
        dialogPic.show();
    ...
    class HolderProductUser extends RecyclerView.ViewHolder {
        ...
        private TextView discountNoteTv, titleTv, descriptionTv, addToCartTv, discountedPriceTv, originalPriceTv,unitTv;
