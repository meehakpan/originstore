...
import com.imesconsult.originstore.FilterOrderShop;
import com.imesconsult.originstore.sellers.OrderDetailsSellerActivity;
...
public class AdapterOrderShop extends RecyclerView.Adapter<AdapterOrderShop.HolderOrderShop> implements Filterable {
    ...
    public void onBindViewHolder(@NonNull HolderOrderShop holder, int position) {
        ...
        //convert time to proper formate
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("orderBy",orderBy); //to load info of the user who place order
    ...
    private void loadUserInfo(ModelOrderShop modelOrderShop, final HolderOrderShop holder) {
        //to load email of the user/buyer : modelOrderShop.getOrderBy() contains uid of that user/buyer who placed order
