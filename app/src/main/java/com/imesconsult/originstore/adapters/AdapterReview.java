...
import com.imesconsult.originstore.models.ModelReview;
...
public class AdapterReview extends RecyclerView.Adapter<AdapterReview.HolderReview>{
    ...
    public void onBindViewHolder(@NonNull HolderReview holder, int position) {
        ...
        //convert timestamp to proper time formate
        ...
        ref.child(uid)
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        try {
                            Picasso.get().load(profileImage).placeholder(R.drawable.person_grey).into(holder.profileIv);

                        }catch (Exception e){
                            //if anything goes wrong  setting image (Exception occurs), set default image
                            holder.profileIv.setImageResource(R.drawable.person_grey);
